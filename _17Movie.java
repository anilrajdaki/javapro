...
public class _17Movie {
	    ...
	    public _17Movie(String title, String director, int maxActors, int maxReviews) {
	        this.title = title;
	    ...
	    public static void main(String[] args) {
	        ...
	        _17Movie movie = new _17Movie(title, director, maxActors, maxReviews);
