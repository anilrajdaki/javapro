...
public class _14School {
	...
	public _14School(String name, int maxStudents, int maxTeachers, int maxClasses) {
		        this.name = name;
	...
	public static void main(String[] args) {
		_14School s = new _14School("St.Tribe", 3, 3, 3);
		s.addStudent("Anil Raj");
		s.addStudent("Hari");
